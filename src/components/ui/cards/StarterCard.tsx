...
const StarterCard = ({ item }: { item: StarterItem }) => {
  ...
  return (
    <div
      ...
      className='bg-linear-to-b from-[#1a0000] to-[#2b0000] rounded-2xl overflow-hidden border border-white/15 flex flex-row md:flex-col justify-between cursor-pointer h-[170px] sm:h-[570px] lg:h-auto active:scale-[0.98] active:brightness-90 transition-all select-none active:from-[#310000] active:to-[#430000]'
      onClick={() =>
