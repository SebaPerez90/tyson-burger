...
const DesertCard = ({ item }: { item: DesertItem }) => {
  ...
  return (
    <div
      ...
      key={item.id}
      className='bg-linear-to-b from-[#1a0000] to-[#2b0000] rounded-2xl overflow-hidden border border-white/15 flex flex-row lg:flex-col justify-between h-auto lg:h-auto transition-all select-none'>
      {/* IMAGE */}
