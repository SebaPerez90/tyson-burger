...
const CartContainer = () => {
  ...
  if (isDetail || isPromoDetail) return null;
    ...
    <div
      className={`${
        clientOrder.length === 0 || !clientOrder
          ? 'hidden'
          : 'cartContainer fixed sm:scale-100 scale-75 block cursor-pointer top-[93%] sm:top-[90%] sm:right-4 right-0 z-50 max-w-[1400px]'
      } `}>
