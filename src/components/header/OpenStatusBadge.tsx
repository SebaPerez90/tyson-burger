...
export const OpenStatusBadge = () => {
  ...
  const { isOpen, isWorkDay } = useMemo(() => {
    ...
    const workDays = [4, 5, 6, 0, 1, 3]; //en caso de agregar dias de servicio, el array debe actualizarse a [1,2,3,4,5,6,0] por ejemplo
  ...
  return (
    <div className="select-none flex items-center space-x-2 bg-background/20 backdrop-blur-md sm:px-4 px-2 py-1 sm:py-1.5 rounded-full border border-background/10 shadow-sm ">
