...
const extras = [
  { id: "extra-1", label: "Extra medallon de carne", price: "$ 4.000" },
  { id: "extra-2", label: "Extra cheddar al medallon", price: "$ 500" },
  {
    id: "extra-3",
    label: "Doble bacon extra",
    price: "$ 2.500",
  },
  { id: "extra-5", label: "Extra cheddar a tus papas", price: "$ 2.000" },
  { id: "extra-6", label: "Extra bacon a tus papas", price: "$ 2.000" },
  {
    id: "extra-7",
            ...
            {extras.map((extra, index) => (
              <li
                ...
                className={`flex justify-between items-center pb-2 ${
                  index !== extras.length - 1 ? "border-b border-white/10" : ""
                }`}
              >
